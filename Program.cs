namespace Random
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            List<ReadData> readDatas = ReadDataFromFile("/home/bruh/school11A/Asztali/Lajhar/lajharok.txt");
        ...
        public static string SlothCouples(List<ReadData> readData)
        {
            ...
            {
                returnString += $"{allCouples[i, 0].Name} es {allCouples[i, 1].Name} nekik {allCouples[i, 0].Childer} gyerekuk van \n";
            }
